...
@Component({
  selector: 'app-viewalleachintern',
  templateUrl: './viewalleachintern.component.html',
  styleUrls: ['./viewalleachintern.component.css']
})
export class ViewalleachinternComponent implements OnInit {
  users1:any;
  username:any;
  uu:any;
  U:any;
  ...
  eacht(uu){
    // console.log(uu._id);
    this.rt.navigate(['alladmins/interns/tasks/onetask',{id:uu._id}])
  }
  loggout()
  {
